...
var (
	...
	// ErrTooManyPaths is returned by ValidateArtifact when a profile holds
	// more than MaxArtifactPaths paths.
...
// paths in AllowedExecutables and AllowedLibraries, compared as the merge
// matches them, and every path ValidateArtifact rejects for a reason other
// than its size: relative paths (ErrRelativePath), patterns apparmor_parser
